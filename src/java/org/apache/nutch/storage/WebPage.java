...
public class WebPage extends PersistentBase {
	...
	public static enum Field {
		BASE_URL(0, "baseUrl"), STATUS(1, "status"), FETCH_TIME(2, "fetchTime"), PREV_FETCH_TIME(
				...
				"contentType"), PREV_SIGNATURE(10, "prevSignature"), SIGNATURE(
				11, "signature"), TITLE(12, "title"), TEXT(13, "text"), PARSE_STATUS(
				14, "parseStatus"), SCORE(15, "score"), REPR_URL(16, "reprUrl"), HEADERS(
	...
	public static final String[] _ALL_FIELDS = { "baseUrl", "status",
			...
			"prevSignature", "signature", "title", "text", "parseStatus",
			"score", "reprUrl", "headers", "outlinks", "inlinks", "markers",
			"metadata", };
	static {
