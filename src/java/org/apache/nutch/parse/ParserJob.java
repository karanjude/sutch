...
public class ParserJob extends NutchTool implements Tool {
		...
		public void map(String key, WebPage page, Context context)
			...
			if (pstatus != null) {
				context.getCounter("ParserStatus",
						ParseStatusCodes.majorCodes[pstatus.getMajorCode()])
						.increment(1);
			}
	...
	public Collection<WebPage.Field> getFields(Job job) {
		...
		Collection<WebPage.Field> signaturePluginFields = SignatureFactory
				.getFields(conf);
		Collection<WebPage.Field> htmlParsePluginFields = parseFilters
				.getFields();
	...
	public Map<String, Object> run(Map<String, Object> args) throws Exception {
		...
		StorageUtils.initMapperJob(currentJob, fields, String.class,
				WebPage.class, ParserMapper.class);
